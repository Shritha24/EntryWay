...
var gateway = new braintree.BraintreeGateway({
  ...
  /*BRAINTREE_MERCHENT_ID :"79bbwmgmqcspnw97",
BRAINTREE_PUBLIC_KEY:"gbyy3tzjyt2yyhwx",
BRAINTREE_PRIVATE_KEY:"6e01bfeab1ca67e26d9c46e2c284e8d8"*/
merchantId: "79bbwmgmqcspnw97",
  publicKey: "gbyy3tzjyt2yyhwx",
  privateKey: "6e01bfeab1ca67e26d9c46e2c284e8d8",
});
...
export const deleteSiteController = async (req, res) => {
  ...
  //similar sites
  export const relatedSiteController=async()=>{
    try{
    ...
    }catch(error)
    {
      ...
      res.status(400).send({
        success:false,
        message:"error while getting related site",
        error
  ...
  export const braintreePaymentController=async(req,res)=>{
    try {
      ...
      let total=0;
      cart.map((i) =>{total+=i.ticketPrice});
